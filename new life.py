...
class Game(tk.Tk):
    ...
    def print8(self, row, column, x1, y1, x2, y2):
        ...
        self.canvas.create_text((x1 + x2) / 2, (y1 + y2) / 2, font=("Arial", 36), fill="blue", text="8")
    ...
    def print16(self, row, column, x1, y1, x2, y2):
        ...
        self.canvas.create_text((x1 + x2) / 2, (y1 + y2) / 2, font=("Arial", 36), fill="blue", text="16")
    ...
    def print32(self, row, column, x1, y1, x2, y2):
        ...
        self.canvas.create_text((x1 + x2) / 2, (y1 + y2) / 2, font=("Arial", 36), fill="blue", text="32")
    ...
    def print64(self, row, column, x1, y1, x2, y2):
        ...
        self.canvas.create_text((x1 + x2) / 2, (y1 + y2) / 2, font=("Arial", 36), fill="blue", text="64")
    ...
    def print128(self, row, column, x1, y1, x2, y2):
        ...
        self.canvas.create_text((x1 + x2) / 2, (y1 + y2) / 2, font=("Arial", 32), fill="blue", text="128")
    ...
    def print256(self, row, column, x1, y1, x2, y2):
        ...
        self.canvas.create_text((x1 + x2) / 2, (y1 + y2) / 2, font=("Arial", 32), fill="blue", text="256")
    ...
    def print512(self, row, column, x1, y1, x2, y2):
        ...
        self.canvas.create_text((x1 + x2) / 2, (y1 + y2) / 2, font=("Arial", 32), fill="blue", text="512")
    ...
    def print1024(self, row, column, x1, y1, x2, y2):
        ...
        self.canvas.create_text((x1 + x2) / 2, (y1 + y2) / 2, font=("Arial", 30), fill="blue", text="1024")
    ...
    def print2048(self, row, column, x1, y1, x2, y2):
        ...
        self.canvas.create_text((x1 + x2) / 2, (y1 + y2) / 2, font=("Arial", 30), fill="blue", text="2048")

    # Creates buttons at top of screen
    def create_widgets(self):
        self.buttonframe = tk.Frame(self)
        self.buttonframe.grid(row=2, column=0, columnspan=4)
        tk.Button(self.buttonframe, text="New Game",font=("Comic Sans MS", 12, "italic"), command=self.new_game).grid(row=0, column=0)
        tk.Label(self.buttonframe, text="Score:",font=("MV Boli", 10, "bold")).grid(row=0, column=1)
        tk.Label(self.buttonframe, textvariable=self.scorestring,font=("Segoe UI Semibold", 15, "bold")).grid(row=0, column=2)
        tk.Label(self.buttonframe, text="Record:",font=("MV Boli", 10, "bold")).grid(row=0, column=3)
        tk.Label(self.buttonframe, textvariable=self.highscorestring,font=("Segoe UI Semibold", 15, "bold")).grid(row=0, column=4)
...
if __name__ == "__main__":
    ...
    app.wm_title("@bright_hamdan ka 2048 :)")
    app.minsize(420, 450)
    app.maxsize(420, 450)
    app.mainloop()
